...
void Walikota::bangun()
{
    ...
    while (!isSuccess)
    {
        ...
        if (!isBahanEnough)
        {
            ...
            std::cout << "!" << endl;
            char inginlanjut;
            std::cout << "Apakah ingin melanjutkan membangun? (y/n)";
            cin >> inginlanjut;
            if (inginlanjut == 'n')
            {
                return;
            }
            else if (inginlanjut != 'y')
            {
                std::cout << "Input tidak valid" << endl;
                return;
            }
        }
